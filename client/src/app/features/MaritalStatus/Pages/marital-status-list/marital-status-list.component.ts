...
import { MaritalStatusDialogComponent } from '../../Components/marital-status-dialog/marital-status-dialog.component';
import {
  MaritalStatusDialogData,
  MaritalStatusDialogResult,
...
export class MaritalStatusListComponent {
  ...
  protected readonly data = signal<readonly MaritalStatusListItem[]>([]);
  ...
  protected readonly columns: readonly DataTableColumn<MaritalStatusListItem>[] = [
  ...
  protected readonly actions: readonly DataTableAction<MaritalStatusListItem>[] = [
    { id: 'edit', label: 'Editar', icon: 'edit', tooltip: 'Editar estado civil', color: 'primary' },
  ];
            ...
            return this.service.getPaged(this.currentQuery()).pipe(
              catchError((error: unknown) => {
                ...
                this.errorMessage.set(
                  getApiErrorMessage(error, 'Não foi possível carregar os estados civis.'),
                );
                return EMPTY;
              }),
  ...
  protected onAction(event: DataTableActionEvent<MaritalStatusListItem>): void {
  ...
  private openDialog(data: MaritalStatusDialogData): void {
    this.dialog
      .open<MaritalStatusDialogComponent, MaritalStatusDialogData, MaritalStatusDialogResult>(
