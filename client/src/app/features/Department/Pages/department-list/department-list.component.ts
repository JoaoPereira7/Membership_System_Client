...
export class DepartmentListComponent {
  ...
  protected readonly data = signal<readonly DepartmentListItem[]>([]);
  ...
  protected readonly columns: readonly DataTableColumn<DepartmentListItem>[] = [
  ...
  protected readonly actions: readonly DataTableAction<DepartmentListItem>[] = [
    {
      id: 'edit',
      label: 'Editar',
      icon: 'edit',
            ...
            return this.service.getPaged(this.currentQuery()).pipe(
              catchError((error: unknown) => {
                ...
                this.errorMessage.set(
                  getApiErrorMessage(error, 'Não foi possível carregar os departamentos.'),
                );
                return EMPTY;
              }),
  ...
  protected onAction(event: DataTableActionEvent<DepartmentListItem>): void {
  ...
  private openDialog(data: DepartmentDialogData): void {
    this.dialog
      .open<DepartmentDialogComponent, DepartmentDialogData, DepartmentDialogResult>(
