...
import { FormationAreaDialogComponent } from '../../Components/formation-area-dialog/formation-area-dialog.component';
import {
  FormationAreaDialogData,
  FormationAreaDialogResult,
...
@Component({
  ...
  templateUrl: './formation-area-list.component.html',
  styleUrl: './formation-area-list.component.scss',
...
export class FormationAreaListComponent {
  ...
  protected readonly data = signal<readonly FormationAreaListItem[]>([]);
  ...
  protected readonly columns: readonly DataTableColumn<FormationAreaListItem>[] = [
  ...
  protected readonly actions: readonly DataTableAction<FormationAreaListItem>[] = [
    {
      id: 'edit',
      label: 'Editar',
      icon: 'edit',
      tooltip: 'Editar área de formação',
      color: 'primary',
    },
  ];
            ...
            return this.service.getPaged(this.currentQuery()).pipe(
              catchError((error: unknown) => {
                ...
                this.errorMessage.set(
                  getApiErrorMessage(error, 'Não foi possível carregar as áreas de formação.'),
                );
                return EMPTY;
              }),
  ...
  protected onAction(event: DataTableActionEvent<FormationAreaListItem>): void {
  ...
  private openDialog(data: FormationAreaDialogData): void {
    this.dialog
      .open<FormationAreaDialogComponent, FormationAreaDialogData, FormationAreaDialogResult>(
        FormationAreaDialogComponent,
        {
          width: '520px',
          maxWidth: '95vw',
          autoFocus: false,
